...
To gather the latency and CPU usage metrics of this environment the data is gathered through Elasticsearch and presented through Kibana. The average latency over 15 minutes of run time for this environment is 10.810ms and 4.002ms for HTTP and MQTT respectively. For CPU usage the entire environment required on average 0.542\% of the CPU and 0.465\% of memory. This is a 1.484ms and 2.170ms increase in latency for HTTP and MQTT respectively over the unencrypted environment.
